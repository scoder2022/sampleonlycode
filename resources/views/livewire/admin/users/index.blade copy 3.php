                    ...
                    <div>
                        <table class="table table-striped table-hover">
                            <thead>
                                ...
                                && getOrderByParam('sort') == 'desc' ? 'down' : 'up' }}  sortBy"  wire:click="sortBy('status','{{ $sorting }}')" sortBy="status">
                                            </i>Status</a></th>
                                    <th>Actions</th>
                                </tr>
                            </thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div>
                                            ...
                                            <input type="checkbox" name="status" value="1" data-size="mini"
                                             wire:change="$emitSelf('updateStatus')" data-forc="User"
                                    ...
                                    @endphp
                                    <td>
                                        <a href="{{ route($this->base_route.'.show',$user->id) }}" class="btn btn-success"
                                            title="Show {{ $panel }} Detail">
                                            <i class="fas fa-eye"></i>
                                        </a>

                                        <a class="btn btn-info" href="{{ route($this->base_route.'.edit',$user->id) }}"
                                            title="Edit {{ $panel }}">
...
<script>
    document.addEventListener('livewire:load', function () {
        ...
        Livewire.on('updateStatus', postId => {
            console.log('here');
        })
