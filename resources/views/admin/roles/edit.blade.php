...
<div class="container">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="text-center">Update {{ $panel }}</h3>
        </div>
        @if ($errors->any())
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('admin.users.update',$data['user']->id) }}" enctype="multipart/form-data" class="form-horizontal"
            method="POST" id="form">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="{{ isset($data) ? $data['user']->email : old('email') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username"
                        value="{{ isset($data) ? $data['user']->username : old('username') }}" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="first_name"
                        value="{{ isset($data) ? $data['user']->first_name : old('first_name') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="middle_name"
                        value="{{ isset($data) ? $data['user']->middle_name : old('middle_name') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="last_name"
                        value="{{ isset($data) ? $data['user']->last_name : old('last_name') }}" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="select2-purple">
                            <select name="status" class="form-control">
                                ...
                                <option value="1" {{ isset($data) && $data['user']->status == 1 ? 'selected="selected"'  : '' }}>Active</option>
                                <option value="0" {{ isset($data) && $data['user']->status == 0 ? 'selected="selected"'  : '' }}>In-active</option>
                                <option value="2" {{ isset($data) && $data['user']->status == 2 ? 'selected="selected"'  : '' }}>suspense</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            @php
                            if(isset($data) && $data['user']->image !='' && \Storage::exists($folder_path.DIRECTORY_SEPARATOR.$data['user']->image)){
                                $thumbnail = $images_path.'/'.$user->image;
                            }else{
