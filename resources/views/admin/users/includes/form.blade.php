    ...
    <div class="col-sm-12">
        ...
        <div class="form-group">
            ...
            <select name="roles[]" class="select2" multiple="multiple" data-placeholder="Select Roles" style="width: 100%;">
             ...
             <option value="{{ $role->id }}"
                @if(isset($data))
                    {{ in_array($role->id,usersRoleIds($data)) ? 'selected':'' }}
        ...
        <div class="form-group">
            ...
            <div class="icheck-success d-inline">
                ...
                @if(isset($data))
                    {{ in_array($role->id,usersRoleIds($data)) ? 'checked':'' }}
                @elseif(!empty(old('roles')))
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <div class="custom-file">
                    @php
                    if(isset($data) && $data->image != null && \Storage::exists('Uploads'.DIRECTORY_SEPARATOR.$folder_name.DIRECTORY_SEPARATOR.$data->image)){
                        $thumbnail = $images_path.'/'.$data->image;
                    }else{
