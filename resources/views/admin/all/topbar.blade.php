<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-link">
            <a class="btn btn-success" onclick="return confirm(' Are You Sure This Will Clear All Cache Data Cookie And Session ?')"
                href="{{ route('admin.clear-site') }}">Sites Full Clear</a>
            <a class="btn btn-success" onclick="return confirm(' Are You Sure This Will Clear All Cache ?')"
                href="{{ route('admin.clear-cache') }}">Sites Cache Clear</a>
          </li>
